"""Application settings for bizon-platform."""
...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://bizon:bizon@localhost:5432/bizon_platform"
    ...
    docker_runner_image: str = "bizon-platform:latest"
